...
class AuthService:
    ...
    def _validate_config(self):
        ...
        if not self.jwt_secret or self.jwt_secret == "your-super-secret-jwt-key-change-this":
            logger.warning("⚠️ JWT_SECRET_KEY is using default value - please change in production")
        
        logger.info("✅ AuthService configuration validated")
