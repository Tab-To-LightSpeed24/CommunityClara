...
class Violation(Base):
    """Content violations (with message content for moderation)"""
    ...
    message_content = Column(Text, nullable=True)  # Store actual message content
    channel_name = Column(String, nullable=True)   # Store channel name like "#general"
