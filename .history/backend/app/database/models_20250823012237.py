...
class Server(Base):
    """Discord server configuration and statistics - COMPLETE VERSION"""
    ...
    spam_threshold = Column(Float, default=0.7)  # ADD THIS
    harassment_threshold = Column(Float, default=0.7)  # ADD THIS
    ...
    warning_enabled = Column(Boolean, default=True)  # ADD THIS
    escalation_enabled = Column(Boolean, default=True)  # ADD THIS
