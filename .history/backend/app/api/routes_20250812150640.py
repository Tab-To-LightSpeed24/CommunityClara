...
async def discord_login():
    ...
    oauth_url = discord_oauth.get_oauth_url()
...
async def discord_callback(code: str):
    ...
    try:
        ...
        user_guilds = discord_oauth.get_user_guilds(token_data['access_token'])
        
        # Create JWT token
        jwt_token = discord_oauth.create_jwt_token(user_info)
