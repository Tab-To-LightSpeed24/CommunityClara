...
def main():
    ...
    try:
        ...
        print(f"🔐 Google OAuth: {'✅ Configured' if os.getenv('GOOGLE_CLIENT_ID') else '❌ Not configured'}")  # Add this line
        ...
        if not os.getenv('GOOGLE_CLIENT_ID'):  # Add this check
            print("⚠️  Google OAuth not configured!")
            print("   Add GOOGLE_CLIENT_ID to your .env file to enable authentication")
            print()
