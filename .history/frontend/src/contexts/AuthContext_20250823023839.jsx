...
export const AuthProvider = ({ children }) => {
  ...
  useEffect(() => {
    // Replace the checkAuth function in frontend/src/contexts/AuthContext.jsx
    const checkAuth = async () => {
      ...
      if (token) {
        try {
          ...
          // DON'T load mock user - stay unauthenticated
          setUser(null)
          setIsAuthenticated(false)
          console.log('🔐 No valid token, user needs to sign in')
        }
      } else {
