...
const BotConfig = ({ serverId }) => {
  ...
  const thresholdSettings = [
    ...
    },
    {
      ...
      icon: '🔞',
      description: 'Sensitivity for detecting adult and inappropriate content',
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-medium text-blue-600">
                    {(() => {
                      const avg = (config.toxicity_threshold + config.nsfw_threshold + config.spam_threshold + config.harassment_threshold) / 4
