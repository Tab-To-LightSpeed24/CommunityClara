...
const GoogleSignIn = ({ onSuccess, onError }) => {
  ...
  // Move functions outside useEffect to fix scope issues
  ...
  }, [handleGoogleResponse, showFallbackButton])
  ...
  useEffect(() => {
    const loadGoogleScript = () => {
      ...
      script.defer = true
      script.onload = () => {
        // Add small delay to ensure Google library is fully loaded
    ...
    loadGoogleScript()
  }, [initializeGoogleSignIn, showFallbackButton])
