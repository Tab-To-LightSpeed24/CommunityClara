...
const Dashboard = () => {
  ...
  const queryClient = useQueryClient() // Added this line
  ...
  // 🔄 FORCE REFRESH DASHBOARD DATA - Added this useEffect
  React.useEffect(() => {
    if (selectedServerId) {
      console.log('🔄 Force refreshing dashboard data for server:', selectedServerId)
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-600">Monitor and manage your Discord server safety</p>
        </div>
