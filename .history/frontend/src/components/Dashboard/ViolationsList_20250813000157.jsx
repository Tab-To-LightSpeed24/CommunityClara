...
const getViolationConfig = (type) => {
  const configs = {
    ...
    spam: { icon: '📧', color: 'text-blue-600 dark:text-blue-400', bgColor: 'bg-blue-100 dark:bg-blue-900/30' },
    harassment: { icon: '😡', color: 'text-red-600 dark:text-red-400', bgColor: 'bg-red-100 dark:bg-red-900/30' },
    hate_speech: { icon: '💢', color: 'text-purple-600 dark:text-purple-400', bgColor: 'bg-purple-100 dark:bg-purple-900/30' },
    threats: { icon: '⚡', color: 'text-red-700 dark:text-red-300', bgColor: 'bg-red-200 dark:bg-red-900/50' },
    self_harm: { icon: '⚠️', color: 'text-yellow-600 dark:text-yellow-400', bgColor: 'bg-yellow-100 dark:bg-yellow-900/30' }
  }
