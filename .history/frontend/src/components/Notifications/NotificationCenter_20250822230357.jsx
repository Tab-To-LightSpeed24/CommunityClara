...
const NotificationCenter = () => {
  ...
  const deleteNotificationMutation = useMutation({
    mutationFn: (notificationId) => apiEndpoints.deleteNotification(notificationId),
    onSuccess: () => {
      queryClient.invalidateQueries(['notifications'])
    }
  })
                  ...
                  <div className="flex items-start justify-between">
                    ...
                    <div className="flex items-center space-x-2 ml-4">
                      {!notification.read && (
                        ...
                        >
                          {markAsReadMutation.isLoading ? 'Reading...' : 'Mark Read'}
                        </button>
                      )}
                      <button
                        onClick={() => deleteNotification(notification.id)}
                        className="text-xs px-2 py-1 bg-red-100 text-red-700 rounded hover:bg-red-200 dark:bg-red-900/30 dark:text-red-400 dark:hover:bg-red-900/50"
