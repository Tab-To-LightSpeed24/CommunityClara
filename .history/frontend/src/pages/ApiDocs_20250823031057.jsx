    ...
    <div className="space-y-8">
      ...
      <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4">
        <div className="flex items-center mb-2">
          ...
          <h3 className="font-semibold text-yellow-800 dark:text-yellow-200">API Key</h3>
        </div>
        <p className="text-yellow-700 dark:text-yellow-300 text-sm mb-3">
          Replace "your-api-key-here" with your actual API key from your dashboard
        </p>
        <div className="flex items-center space-x-2">
          <input
            ...
            className="flex-1 px-3 py-2 border border-yellow-300 dark:border-yellow-700 rounded-md bg-white dark:bg-gray-800 text-sm"
            placeholder="Enter your API key"
          />
          <button
            onClick={() => setCurrentPage('profile')}
            className="btn bg-yellow-600 text-white hover:bg-yellow-700 px-4 py-2 rounded-md text-sm"
          >
            Get API Key
          </button>
        </div>
