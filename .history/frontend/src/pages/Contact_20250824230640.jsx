  ...
  const handleChange = (e) => {
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        ...
        const response = await apiEndpoints.sendContactMessage(formData)
        
        // Use the existing submitted state instead of message
        setSubmitted(true)
        ...
        // You could show an alert or add a proper error display
        alert(error.response?.data?.detail || error.message || 'Failed to send message. Please try again.')
