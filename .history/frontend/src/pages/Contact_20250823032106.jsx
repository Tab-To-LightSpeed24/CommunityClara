    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg p-6 text-white text-center">
          ...
          <p className="text-sm opacity-90 mb-4">Available 24/7 for urgent issues</p>
          <button className="btn bg-white text-blue-600 hover:bg-gray-100 px-4 py-2 rounded">
            Start Chat
          </button>
        </div>
        ...
        <div className="bg-gradient-to-r from-purple-500 to-purple-600 rounded-lg p-6 text-white text-center">
          ...
          <button className="btn bg-white text-purple-600 hover:bg-gray-100 px-4 py-2 rounded">
            Send Email
          </button>
        </div>
        ...
        <div className="bg-gradient-to-r from-green-500 to-green-600 rounded-lg p-6 text-white text-center">
          ...
          <p className="text-sm opacity-90 mb-4">Join our community</p>
          <button className="btn bg-white text-green-600 hover:bg-gray-100 px-4 py-2 rounded">
            Join Server
          </button>
        </div>
      </div>
