...
function AppContent() {
              ...
              <div className="space-y-6">
                <div className="flex space-x-4 border-b border-gray-200/50 dark:border-gray-700/50">
                  <button
                    ...
                    className={`px-4 py-2 font-medium transition-colors duration-200 border-b-2 ${settingsTab === 'bot'
                  ...
                  <button
                    ...
                    className={`px-4 py-2 font-medium transition-colors duration-200 border-b-2 ${settingsTab === 'server'
                      ? 'border-purple-500 text-purple-600 dark:text-purple-400'
                      : 'border-transparent text-gray-600 dark:text-gray-300 hover:text-purple-600 dark:hover:text-purple-400'
                      }`}
                  >
  ...
  return (
    <div className="min-h-screen bg-transparent transition-colors duration-300">
      ...
      {/* Main Content - Full Width with Floating Nav Compensation */}
      <main className="transition-all duration-300 pt-28 pb-12">
